...
export const mockRoom: RoomView = {
  ...
  seats: [
    { seatIndex: 0, user: mockLoginResult.user, isReady: true, isOwner: true },
...
export const mockFinishedView: PlayerGameView = {
  ...mockGameView,
  status: 'FINISHED',
  result: {
    winnerIndexes: [0],
...
export const mockReplaySummary: ReplaySummary = {
  gameId: mockFinishedView.gameId,
  roomId: mockFinishedView.roomId,
  finishedAt: Date.now(),
  title: '曲靖飞小鸡 Mock 对局',
  result: mockFinishedView.result,
};

export const mockReplay: ReplayDetail = {
  ...mockReplaySummary,
  steps: [
    { stepIndex: 1, view: { ...mockGameView, stepIndex: 1 }, events: [] },
    {
      stepIndex: 18,
      view: mockFinishedView,
